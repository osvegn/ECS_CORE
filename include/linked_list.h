...
/**
 * Creating a new type called linked_list_t.
 */
...
/**
 * It frees all the memory allocated for the linked list
 * 
...
/**
 * Return the data at the given index in the linked list.
 * 
...
/**
 * If the list is not empty, return the last element of the list.
 * 
...
/**
 * If the size of the list is not zero, return false, otherwise return true.
 * 
...
/**
 * Create a new node, find the last node in the list, set the new node's previous
...
/**
 * It removes the node at the given index from the list
 * 
